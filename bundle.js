...
function checkForCollisions(entity, entitiesCallback, vector) {
    ...
    var collidingWith = _.filter(collidableEntities, function checkAgainstCollidableEntities(entityMap) {
        ...
        var testEntity = entityMap.entity,
            ...
            if(!entity.isEnemy && testBool) console.log(testResponse);

            return testBool && testResponse.overlap > 0.01;
    });
...
},{"sat":21,"underscore":22}],2:[function(require,module,exports){
var _ = require("underscore"),
...
},{"../Helpers/unary":13,"underscore":22}],3:[function(require,module,exports){
...
window.requestAnimationFrame(renderStep);
},{"../CanvasArtist":5,"../Helpers/dictionary":10,"underscore":22}],5:[function(require,module,exports){
...
},{"../Behaviours/collidable":1,"../Behaviours/healthable":2,"../Behaviours/moveable":3,"../Behaviours/renderable":4,"../Helpers/uniqueId":14,"../entity":16,"underscore":22}],7:[function(require,module,exports){
...
},{"./Behaviours/renderable":4,"./Factories/dudeFactory":6,"./Factories/enemyFactory":7,"./Factories/wallFactory":8,"./Input/gamepad":15,"./eventList":17,"./map":19,"underscore":22}],19:[function(require,module,exports){
var Entity = require("./entity"),
    unary = require("./Helpers/unary");
